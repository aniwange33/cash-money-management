...
//        registrationBean.urlPatterns = listOf("/v1/api/app/*")
...
//    @Autowired
//    lateinit var appProperty: AppProperty;
...
//        if (appProperty.appClientKey != clientKey) {
//            val apiResponse = ApiResponse<String>("Unauthorised Access: Invalid client key")
